...
def main():
    img1 = cv2.imread("D:/Documents/ImgProcess/picture/dt.png", cv2.IMREAD_GRAYSCALE)
    #print("Image shape:", img1.shape)
    img2 = skeletonization(img1)
    #print("Skeletonized image shape:", img2.shape)
    cv2.imwrite("Skeletonization.png", img2)
    cv2.waitKey(0)
